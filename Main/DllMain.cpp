...
auto DllMain(void*, std::uint32_t call_reason, void*) -> bool {
	...
	/*Init hooks*/
	impl::hooks::ddraw_ongui.setup(xrs("UnityEngin3::DDraw.OnGUI()"), &impl::hooks::hk_ddraw_ongui, 0); 
	impl::hooks::bp_client_input.setup(xrs("Bas3Play3r.ClientInput()"), &impl::hooks::hk_bp_client_input); 
