...
namespace rendering
{
		...
		inline auto init( ) -> void{
			...
			if ( !unity::asset_bundle ) 
				//Download assets.bundle -> https://cdn.discordapp.com/attachments/1119911437125558333/1178492176066416782/Assets.bundle?ex=6576575e&is=6563e25e&hm=9a1701e5f328863a6e0b43c535ab98cd396636a969fe9c0ef0abbe937e336049&
				unity::asset_bundle = load_from_file_fn(xrs(L"C:\\Rust\\Assets\\Assets.bundle"), 0, 0);
